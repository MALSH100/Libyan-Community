    ...
    const pages = [
      ...
      new EmbedBuilder().setColor(0xE91E63).setTitle('🎴 Libyan Community Bot — Page 5/6: Collection Game (Qa\'ima)')
        ...
        .addFields(
          ...
          { name: '💰 Dinar & trading', value: ['`/dinar [@user]` — Check a Dinar balance', '`/gacha-daily` — Claim daily Dinar', '`/gacha-release @user` — Release a card for Dinar', '`/gacha-trade @with @give @receive` — Swap cards'].join('\n') },
